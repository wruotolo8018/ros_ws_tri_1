...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.mode = 0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum': [{'name': 'Basic', 'type': 'int', 'value': 0, 'srcline': 37, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Basic mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Pinch', 'type': 'int', 'value': 1, 'srcline': 38, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Pinch mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Wide', 'type': 'int', 'value': 2, 'srcline': 39, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Wide mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Scissor', 'type': 'int', 'value': 3, 'srcline': 40, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Scissor mode', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set the grasp operation mode'}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum': [{'name': 'Basic', 'type': 'int', 'value': 0, 'srcline': 37, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Basic mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Pinch', 'type': 'int', 'value': 1, 'srcline': 38, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Pinch mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Wide', 'type': 'int', 'value': 2, 'srcline': 39, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Wide mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Scissor', 'type': 'int', 'value': 3, 'srcline': 40, 'srcfile': '/home/wilson/ros_ws_1/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Scissor mode', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set the grasp operation mode'}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
