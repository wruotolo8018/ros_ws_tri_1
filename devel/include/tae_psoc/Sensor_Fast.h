...
bool operator==(const ::tae_psoc::Sensor_Fast_<ContainerAllocator1> & lhs, const ::tae_psoc::Sensor_Fast_<ContainerAllocator2> & rhs)
{
  return lhs.sns_1_Fast == rhs.sns_1_Fast &&
    lhs.sns_2_Fast == rhs.sns_2_Fast &&
    lhs.sns_3_Fast == rhs.sns_3_Fast;
}
